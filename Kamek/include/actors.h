...
enum Actors {
	...
	#if defined(REGION_TOURNAMENT) // The Korean and Taiwanese versions have two extra profiles.
	...
	FLIPBLOCK, //750
	STAFFCREDITS, //751
	STAFFCREDITS_CAMERA, //752
	MINECART, //753
	MC_PLAYER, //754
	MC_NODE, //755
	WM_SIGN, //756

	NEWER_SFXGFXSPAWNER, //757
	NEWER_ACTORSPAWNER, //758
	NEWER_MAGICPLATFORM, //759
	BAD_APPLE, //760
	NEWER_EVENTLOOPER, //761
