...
Profile actorSpawnerProfile = Profile((buildFunc)&dActorSpawner_c::build, SpriteId::NEWER_ACTORSPAWNER, &actorSpawnerData, ProfileId::NEWER_ACTORSPAWNER, ProfileId::NEWER_ACTORSPAWNER, 0x12, "NEWER_ACTORSPAWNER", 0);
