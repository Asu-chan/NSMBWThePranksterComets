...
public:
	...
	static dSfxGfxSpawner_c *build();

};


dSfxGfxSpawner_c *dSfxGfxSpawner_c::build() {
...
Profile sfxgfxSpawnerProfile = Profile((buildFunc)&dSfxGfxSpawner_c::build, SpriteId::NEWER_SFXGFXSPAWNER, &sfxgfxSpawnerData, ProfileId::NEWER_SFXGFXSPAWNER, ProfileId::NEWER_SFXGFXSPAWNER, 0x12, "NEWER_SFXGFXSPAWNER", 0);
