...
dScStaffCredits_c::dScStaffCredits_c() : acState(this, &StateID_Init), acState2(this, &StateID_Wait) {
	...
	CreateParentedObject(STAFFCREDITS_CAMERA, this, 0, 0);

	DVD_LoadFile(GetDVDClass(), "Object", "bgA_0104", 0);
	DVD_LoadFile(GetDVDClass(), "MovieDemo", "All", 0);
	DVD_LoadFile(GetDVDClass(), "Worldmap", "character_SV", 0);
}
...
extern "C" void sub_800F6820(void* actor, const char* arcName, const char* brresName, const char* mdlName, u32 unk);
	...
	*CurrentDrawFunc = CreditsDrawFunc;
	if(!layoutLoaded) {
		...
		for(int i = 0; i < 4; i++) {
			...
			// sub_800F6820(this, "character_SV", "g3d/model.brres", "character_SV", 1);
		}
		...
		// shadowAllocator.linkAndBecomeCurrentHeap(-1, GameHeaps[0], 0, 0x20, 0);
		// nw4r::g3d::ResFile rf4(getResource("character_SV", "g3d/model.brres"));
		// nw4r::g3d::ResMdl shadowRes = rf4.GetResMdl("character_SV");
		// this->shadow.setup(shadowRes, &shadowAllocator, 0x20, 1, 0);

		// void *buf = EGG__Heap__alloc(0xC, 4, 0);
		// if(buf) {
		// 	scn = new(buf) m3d::scnLeaf_c;
		// 	*(u32*)scn = 0x8031BF2C;

		// 	void(*fun)(void*, mHeapAllocator_c*, m3d::smdl_c*);
		// 	fun = (void (*)(void*, mHeapAllocator_c*, m3d::smdl_c*))(*(u32*)((*(u32*)scn) + 0x20));

		// 	fun(this, &shadowAllocator, &this->shadow);
		// }
		// shadowAllocator.done();

		// void(*fun)(u32, const char*, Vec*);
		// fun = (void (*)(u32, const char*, Vec*))(0x801007F0);

		// fun(0x8042A46C, "Enemy", &playerPos[1]);
	}
...
int dScStaffCredits_c::onDelete() {
	...
	DVD_FreeFile(GetDVDClass2(), "character_SV");
...
int dScStaffCredits_c::onDraw() {
	...
	// void(*fun)(m3d::scnLeaf_c*);
	// fun = (void (*)(m3d::scnLeaf_c*))(*(u32*)((*(u32*)scn) + 0x14));
